...
const translations = {
  ...
  ml: {
    ...
    whyNammude: {
      ...
      reason4: 'ആധുനിക മെഷീനുകൾ',
      reason5: 'നല്ല വരുമാനാവസരം'
    },
    // Equipment Section
    equipment: {
      title: 'ഞങ്ങളുടെ ഉപകരണങ്ങൾ',
      subtitle: 'കാര്യക്ഷമത, ദൈർഘ്യം, മികച്ച വസ്ത്രപരിപാലനം എന്നിവയ്ക്കായി രൂപകൽപ്പന ചെയ്ത അത്യാധുനിക കൊമേഴ്സ്യൽ ലോണ്ട്രി സിസ്റ്റങ്ങളാണ് ഞങ്ങൾ നൽകുന്നത്.',
      washer: {
        title: 'LG കൊമേഴ്സ്യൽ വാഷർ',
        desc: 'ഡൈരക്ട് ഡ്രൈവ് സാങ്കേതികവിദ്യയും കോയിൻ ഓപ്പറേറ്റഡ് സംവിധാനവും ഉള്ള പ്രൊഫഷണൽ മെഷീൻ.',
        smart: 'സ്മാർട്ട് നിയന്ത്രണം',
        water: 'ജലക്ഷമത',
        coin: 'കോയിൻ സിസ്റ്റം'
      },
      dryer10: {
        title: 'LG 10kg ഡ്രയർ',
        desc: 'അഡ്വാൻസ്ഡ് സെൻസർ സാങ്കേതികവിദ്യയുള്ള കോംപാക്റ്റും ശക്തവുമായ കൊമേഴ്സ്യൽ ഡ്രയർ.',
        capacity: '10kg ശേഷി'
      },
      titan: {
        title: 'LG Titan 15kg',
        desc: 'വലിയ തോതിലുള്ള ഉപയോഗത്തിനായി ഉയർന്ന ശേഷിയുള്ള ഇലക്ട്രിക് ഡ്രയർ.',
        capacity: '15kg ശേഷി'
      },
      gas: {
        title: 'LG ഗ്യാസ് ഡ്രയർ',
        desc: 'തിരക്കേറിയ ലോണ്ട്രികൾക്കായി സ്ഥിര പ്രകടനവും കുറഞ്ഞ പ്രവർത്തന ചെലവും നൽകുന്ന ചെലവുകുറഞ്ഞ ഗ്യാസ് പരിഹാരം.',
        cost: 'ചെലവുകുറവ്',
        reliable: 'വിശ്വാസ്യത',
    ...
    // Training Section
    training: {
      title: 'പരിശീലനം & കഴിവ് വികസനം',
      subtitle: 'ഞങ്ങൾ നൽകുന്ന പരിശീലനം:',
      module1: 'ലോണ്ട്രി മെഷീൻ പ്രവർത്തനം',
      module2: 'മെഷീൻ പരിപാലനം',
      module3: 'വസ്ത്രം കഴുകൽ & സ്റ്റെയിൻ നീക്കം',
      module4: 'ഷോപ്പ് മാനേജ്മെന്റ്',
      module5: 'ഹൈജീൻ & സുരക്ഷാ മാനദണ്ഡങ്ങൾ',
      module6: 'ഉപഭോക്തൃ കൈകാര്യം ചെയ്യൽ',
      module7: 'വിലനിർണ്ണയം & ലാഭ ഓപ്റ്റിമൈസേഷൻ'
    },
    // Who Can Join Section
    whoCanJoin: {
      title: 'ആർക്കെല്ലാം ചേരാം?',
      subtitle: 'മുന്‍പരിചയം ആവശ്യമില്ല',
      category1: 'പരമ്പരാഗത ധോബി കുടുംബങ്ങൾ',
      desc1: 'നിങ്ങളുടെ പരമ്പരാഗത കഴിവ് ആധുനിക സാങ്കേതികവിദ്യയിലൂടെ ഉയർത്തിക്കൊണ്ട് സ്ഥിരതയുള്ള ബിസിനസ് നിർമ്മിക്കുക.',
      category2: 'സ്ത്രീകൾ / ഗൃഹണികൾ',
      desc2: 'കുടുംബ ബാധ്യതകളോട് ഒത്തു പോകുന്ന സമയക്രമത്തിൽ സാമ്പത്തിക സ്വാതന്ത്ര്യം നേടൂ.',
      category3: 'ഭിന്നശേഷിക്കാർ',
      desc3: 'അർത്ഥവത്തായ തൊഴിൽക്ക് തുല്യാവസരം. പ്രത്യേക പരിശീലനവും ലഭ്യത സൗഹൃദ ഉപകരണങ്ങളും നൽകുന്നു.',
      category4: 'തൊഴിൽ ഇല്ലാത്ത യുവാക്കൾ',
      desc4: 'പൂർണ്ണ പിന്തുണയോടെ സംരംഭക യാത്ര ആരംഭിക്കുക. പ്രായോഗിക കഴിവുകൾ അഭ്യസിച്ച് സ്വന്തമായി ബിസിനസ് തുടങ്ങുക.',
    ...
    franchise: {
      title: 'ഫ്രാഞ്ചൈസി',
      subtitle: 'ഞങ്ങൾ നൽകുന്നത്:',
      item1: 'പൂർണ്ണ ബിസിനസ് സെറ്റപ്പ്',
      item2: 'സ്റ്റോർ ഡിസൈൻ',
      item3: 'ബ്രാൻഡ് നെയിം',
      item4: 'മെഷീനുകൾ',
    ...
    // CSR & Government Support Section
    csrSupport: {
      title: 'CSR & സർക്കാർ പിന്തുണ',
      subtitle: 'ഞങ്ങൾ സഹകരിക്കുന്നത്:',
      partner1: 'കോർപ്പറേറ്റ് CSR പദ്ധതികൾ',
      partner2: 'ബാങ്കുകൾ',
    ...
    <footer className="bg-white text-slate-600 py-12 border-t border-slate-200 z-10 relative" role="contentinfo" aria-label="Nammude Laundry footer">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="text-sm">
          © {new Date().getFullYear()} NAMMUDE LAUNDRY � NAMMUDE LAUNDRY. {t.footer.rights}
        </div>
      </div>
    </footer>
  );
