...
const translations = {
  ...
  ml: {
    ...
    nav: {
      ...
      vision: 'à´²à´•àµà´·àµà´¯à´‚',
      whyNammude: 'à´Žà´¨àµà´¤àµà´•àµŠà´£àµà´Ÿàµ à´žà´™àµà´™àµ¾',
      equipment: 'à´‰à´ªà´•à´°à´£à´™àµà´™àµ¾',
      training: 'à´ªà´°à´¿à´¶àµ€à´²à´¨à´‚',
      whoCanJoin: 'à´†àµ¼à´•àµà´•àµ†à´²àµà´²à´¾à´‚ à´šàµ‡à´°à´¾à´‚',
      franchise: 'à´«àµà´°à´¾à´žàµà´šàµˆà´¸à´¿',
      csrSupport: 'CSR & à´ªà´¿à´¨àµà´¤àµà´£',
    ...
    // Hero Section
    hero: {
      badge: 'à´¸àµà´µà´¯à´‚ à´µà´°àµà´®à´¾à´¨à´‚ à´¸àµƒà´·àµà´Ÿà´¿à´•àµà´•àµà´¨àµà´¨ à´ªà´¦àµà´§à´¤à´¿',
      title1: 'à´¨à´®àµà´®àµà´Ÿàµ† à´²àµ‹à´£àµà´Ÿàµà´°à´¿',
      title2: 'à´’à´°àµ à´¬à´¿à´¸à´¿à´¨à´¸àµ - à´’à´°àµ à´œàµ€à´µà´¿à´¤à´®à´¾à´±àµà´±à´‚',
      subtitle: 'à´ªà´°à´®àµà´ªà´°à´¾à´—à´¤ à´§àµ‹à´¬à´¿ à´•àµà´Ÿàµà´‚à´¬à´™àµà´™à´³àµ†à´¯àµà´‚ à´—àµƒà´¹à´£à´¿à´•à´³àµ†à´¯àµà´‚ à´¸à´‚à´°à´‚à´­à´•à´°àµ†à´¯àµà´‚ à´†à´§àµà´¨à´¿à´• à´²àµ‹à´£àµà´Ÿàµà´°à´¿ à´¸à´¾à´™àµà´•àµ‡à´¤à´¿à´•à´µà´¿à´¦àµà´¯à´¯à´¿à´²àµ‚à´Ÿàµ† à´¸àµà´¥à´¿à´° à´µà´°àµà´®à´¾à´¨à´¤àµà´¤à´¿à´²àµ‡à´•àµà´•àµ à´¨à´¯à´¿à´•àµà´•àµà´¨àµà´¨àµ.',
      cta: 'à´¨à´¿à´™àµà´™à´³àµà´Ÿàµ† à´¯à´¾à´¤àµà´° à´¤àµà´Ÿà´™àµà´™àµ‚',
      cta2: 'à´žà´™àµà´™à´³àµ‹à´ŸàµŠà´ªàµà´ªà´‚ à´ªà´™àµà´•à´¾à´³à´¿à´¯à´¾à´•àµ‚',
      brand: 'à´¨à´®àµà´®àµà´Ÿàµ† à´²àµ‹à´£àµà´Ÿàµà´°à´¿',
      tagline: '',
      programTitle: 'à´¸àµà´µà´¯à´‚ à´µà´°àµà´®à´¾à´¨à´‚ à´¸àµƒà´·àµà´Ÿà´¿à´•àµà´•àµà´¨àµà´¨ à´ªà´¦àµà´§à´¤à´¿.'
    },
    // About Section
    about: {
      subtitle: 'à´žà´™àµà´™à´³àµ‡à´•àµà´•àµà´±à´¿à´šàµà´šàµ',
      title: 'à´Žà´µà´¿à´Ÿàµ†',
      tradition: 'à´ªà´°à´®àµà´ªà´°',
      meets: 'à´•à´£àµà´Ÿàµà´®àµà´Ÿàµà´Ÿàµà´¨àµà´¨à´¤àµ',
      innovation: 'à´ªàµà´¤àµà´®',
      p1: 'à´•àµ—à´¶à´²à´µàµà´‚ à´…à´µà´¸à´°à´µàµà´‚ à´’à´¨àµà´¨à´¿à´•àµà´•àµà´¨àµà´¨à´¿à´Ÿà´¤àµà´¤à´¾à´£àµ à´¸àµà´¥à´¿à´°à´®à´¾à´¯ à´œàµ€à´µà´¿à´¤àµ‹à´ªà´¾à´§à´¿. à´‡à´¤à´¾à´£àµ à´¨à´®àµà´®àµà´Ÿàµ† à´²àµ‹à´£àµà´Ÿàµà´°à´¿à´¯àµà´Ÿàµ† à´…à´Ÿà´¿à´¸àµà´¥à´¾à´¨à´‚.',
      p2: 'à´ªà´°à´®àµà´ªà´°à´¾à´—à´¤ à´µà´¸àµà´¤àµà´°à´ªà´°à´¿à´šà´°à´£ à´ªà´°à´¿à´šà´¯à´¤àµà´¤àµ† à´†à´§àµà´¨à´¿à´• à´®àµ†à´·àµ€à´¨àµà´•à´³àµà´®à´¾à´¯à´¿ à´šàµ‡àµ¼à´¤àµà´¤àµ à´µà´¿à´¶àµà´µà´¾à´¸àµà´¯à´¤à´¯àµà´³àµà´³ à´ªàµà´°àµŠà´«à´·à´£àµ½ à´²àµ‹à´£àµà´Ÿàµà´°à´¿ à´¬à´¿à´¸à´¿à´¨à´¸àµà´•àµ¾ à´¨à´¿àµ¼à´®àµà´®à´¿à´•àµà´•à´¾àµ» à´žà´™àµà´™àµ¾ à´¸à´¹à´¾à´¯à´¿à´•àµà´•àµà´¨àµà´¨àµ.',
      p3: 'à´§àµ‹à´¬à´¿ à´•àµà´Ÿàµà´‚à´¬à´™àµà´™àµ¾, à´—àµƒà´¹à´£à´¿à´•àµ¾, à´­à´¿à´¨àµà´¨à´¶àµ‡à´·à´¿à´•àµà´•à´¾àµ¼, à´¤àµŠà´´à´¿àµ½ à´¤àµ‡à´Ÿàµà´¨àµà´¨ à´¯àµà´µà´¾à´•àµà´•àµ¾, à´šàµ†à´±à´¿à´¯ à´¸à´‚à´°à´‚à´­à´•àµ¼ à´Žà´¨àµà´¨à´¿à´µàµ¼à´•àµà´•à´¾à´¯à´¿ à´ªà´°à´¿à´¶àµ€à´²à´¨à´‚, à´‰à´ªà´•à´°à´£à´™àµà´™àµ¾, à´§à´¨à´¸à´¹à´¾à´¯ à´®à´¾àµ¼à´—à´¨à´¿àµ¼à´¦àµà´¦àµ‡à´¶à´‚, à´®àµ†à´¨àµà´±à´±à´¿à´‚à´—àµ à´Žà´¨àµà´¨à´¿à´µ à´¨àµ½à´•àµà´¨àµà´¨àµ.'
    },
    // Vision Section
    vision: {
      title: 'à´žà´™àµà´™à´³àµà´Ÿàµ† à´²à´•àµà´·àµà´¯à´‚',
      p1: 'à´¸à´‚à´˜à´Ÿà´¿à´¤ à´²àµ‹à´£àµà´Ÿàµà´°à´¿ à´¸à´‚à´°à´‚à´­à´•à´¤àµà´µà´¤àµà´¤à´¿à´²àµ‚à´Ÿàµ† à´ªàµà´°à´¾à´¦àµ‡à´¶à´¿à´• à´¸à´®àµà´ªà´¦àµâ€Œà´µàµà´¯à´µà´¸àµà´¥ à´¶à´•àµà´¤à´¿à´ªàµà´ªàµ†à´Ÿàµà´¤àµà´¤àµà´•à´¯àµà´‚ à´µàµà´¯à´•àµà´¤à´¿à´•àµ¾à´•àµà´•àµ à´¸à´¾à´®àµà´ªà´¤àµà´¤à´¿à´• à´¸àµà´µà´¾à´¤à´¨àµà´¤àµà´°àµà´¯à´‚ à´¨àµ‡à´Ÿà´¾àµ» à´¸à´¹à´¾à´¯à´¿à´•àµà´•àµà´•à´¯àµà´‚ à´šàµ†à´¯àµà´¯àµà´•.',
      p2: 'à´ªà´°à´®àµà´ªà´°à´¾à´—à´¤ à´•à´´à´¿à´µàµà´•à´³àµ† à´¸àµà´¥à´¿à´°à´¤à´¯àµà´³àµà´³ à´ªàµà´°àµŠà´«à´·à´£àµ½ à´¬à´¿à´¸à´¿à´¨à´¸àµà´•à´³à´¾à´•àµà´•à´¿ à´®à´¾à´±àµà´±à´¿ à´¸à´®àµ‚à´¹à´¤àµà´¤à´¿à´¨àµà´‚ à´•àµà´Ÿàµà´‚à´¬à´™àµà´™àµ¾à´•àµà´•àµà´‚ à´¦àµ€àµ¼à´˜à´•à´¾à´² à´µà´³àµ¼à´šàµà´š à´¸àµƒà´·àµà´Ÿà´¿à´•àµà´•àµà´¨àµà´¨ à´­à´¾à´µà´¿à´¯à´¾à´£àµ à´žà´™àµà´™à´³àµà´Ÿàµ† à´²à´•àµà´·àµà´¯à´‚.',
      transform: 'à´ªà´°à´¿à´µàµ¼à´¤àµà´¤à´¨à´‚',
      transformDesc: 'à´•à´´à´¿à´µàµà´•à´³àµ† à´ªàµà´°àµŠà´«à´·à´£àµ½ à´¸àµà´¥à´¾à´ªà´¨à´™àµà´™à´³à´¾à´•àµà´•àµ½.',
      create: 'à´¸àµƒà´·àµà´Ÿà´¿à´•àµà´•àµà´•',
      createDesc: 'à´µà´¿à´ªàµà´²àµ€à´•à´°à´¿à´•àµà´•à´¾à´¨à´¾à´•àµà´¨àµà´¨ à´¸à´¾à´®àµà´ªà´¤àµà´¤à´¿à´• à´…à´µà´¸à´°à´™àµà´™àµ¾ à´¨à´¿àµ¼à´®àµà´®à´¿à´•àµà´•àµà´•',
      deliver: 'à´¨à´¿à´±à´µàµ‡à´±àµà´±àµà´•',
      deliverDesc: 'à´¸à´®àµ‚à´¹ à´ªàµà´°àµ‹à´—à´¤à´¿à´•àµà´•àµ à´—àµà´£à´®àµ‡àµ»à´®à´¯àµà´³àµà´³ à´¸àµ‡à´µà´¨à´‚.'
    },
    // Why Nammude Section
    whyNammude: {
      title: 'à´Žà´¨àµà´¤àµà´•àµŠà´£àµà´Ÿàµ à´¨à´®àµà´®àµà´Ÿàµ† à´²àµ‹à´£àµà´Ÿàµà´°à´¿?',
      reason1: 'à´¸à´¾à´®àµ‚à´¹àµà´¯à´•àµà´·àµ‡à´®à´‚ à´²à´•àµà´·àµà´¯à´®à´¾à´•àµà´•à´¿à´¯ à´ªà´¦àµà´§à´¤à´¿',
      reason2: 'à´•àµà´±à´žàµà´ž à´¨à´¿à´•àµà´·àµ‡à´ªà´‚',
      reason3: 'à´ªàµ‚àµ¼à´£àµà´£ à´ªà´¿à´¨àµà´¤àµà´£',
      reason4: 'à´†à´§àµà´¨à´¿à´• à´®àµ†à´·àµ€à´¨àµà´•àµ¾',
      reason5: 'à´¨à´²àµà´² à´µà´°àµà´®à´¾à´¨à´¾à´µà´¸à´°à´‚'
    },
    // Equipment Section
    equipment: {
      title: 'à´žà´™àµà´™à´³àµà´Ÿàµ† à´‰à´ªà´•à´°à´£à´™àµà´™àµ¾',
      subtitle: 'à´•à´¾à´°àµà´¯à´•àµà´·à´®à´¤, à´¦àµˆàµ¼à´˜àµà´¯à´‚, à´®à´¿à´•à´šàµà´š à´µà´¸àµà´¤àµà´°à´ªà´°à´¿à´ªà´¾à´²à´¨à´‚ à´Žà´¨àµà´¨à´¿à´µà´¯àµà´•àµà´•à´¾à´¯à´¿ à´°àµ‚à´ªà´•àµ½à´ªàµà´ªà´¨ à´šàµ†à´¯àµà´¤ à´…à´¤àµà´¯à´¾à´§àµà´¨à´¿à´• à´•àµŠà´®àµ‡à´´àµà´¸àµà´¯àµ½ à´²àµ‹à´£àµà´Ÿàµà´°à´¿ à´¸à´¿à´¸àµà´±àµà´±à´™àµà´™à´³à´¾à´£àµ à´žà´™àµà´™àµ¾ à´¨àµ½à´•àµà´¨àµà´¨à´¤àµ.',
      washer: {
        title: 'LG à´•àµŠà´®àµ‡à´´àµà´¸àµà´¯àµ½ à´µà´¾à´·àµ¼',
        desc: 'à´¡àµˆà´°à´•àµà´Ÿàµ à´¡àµà´°àµˆà´µàµ à´¸à´¾à´™àµà´•àµ‡à´¤à´¿à´•à´µà´¿à´¦àµà´¯à´¯àµà´‚ à´•àµ‹à´¯à´¿àµ» à´“à´ªàµà´ªà´±àµ‡à´±àµà´±à´¡àµ à´¸à´‚à´µà´¿à´§à´¾à´¨à´µàµà´‚ à´‰à´³àµà´³ à´ªàµà´°àµŠà´«à´·à´£àµ½ à´®àµ†à´·àµ€àµ».',
        smart: 'à´¸àµà´®à´¾àµ¼à´Ÿàµà´Ÿàµ à´¨à´¿à´¯à´¨àµà´¤àµà´°à´£à´‚',
        water: 'à´œà´²à´•àµà´·à´®à´¤',
        coin: 'à´•àµ‹à´¯à´¿àµ» à´¸à´¿à´¸àµà´±àµà´±à´‚'
      },
      dryer10: {
        title: 'LG 10kg à´¡àµà´°à´¯àµ¼',
        desc: 'à´…à´¡àµà´µà´¾àµ»à´¸àµà´¡àµ à´¸àµ†àµ»à´¸àµ¼ à´¸à´¾à´™àµà´•àµ‡à´¤à´¿à´•à´µà´¿à´¦àµà´¯à´¯àµà´³àµà´³ à´•àµ‹à´‚à´ªà´¾à´•àµà´±àµà´±àµà´‚ à´¶à´•àµà´¤à´µàµà´®à´¾à´¯ à´•àµŠà´®àµ‡à´´àµà´¸àµà´¯àµ½ à´¡àµà´°à´¯àµ¼.',
        capacity: '10kg à´¶àµ‡à´·à´¿'
      },
      titan: {
        title: 'LG Titan 15kg',
        desc: 'à´µà´²à´¿à´¯ à´¤àµ‹à´¤à´¿à´²àµà´³àµà´³ à´‰à´ªà´¯àµ‹à´—à´¤àµà´¤à´¿à´¨à´¾à´¯à´¿ à´‰à´¯àµ¼à´¨àµà´¨ à´¶àµ‡à´·à´¿à´¯àµà´³àµà´³ à´‡à´²à´•àµà´Ÿàµà´°à´¿à´•àµ à´¡àµà´°à´¯àµ¼.',
        capacity: '15kg à´¶àµ‡à´·à´¿'
      },
      gas: {
        title: 'LG à´—àµà´¯à´¾à´¸àµ à´¡àµà´°à´¯àµ¼',
        desc: 'à´¤à´¿à´°à´•àµà´•àµ‡à´±à´¿à´¯ à´²àµ‹à´£àµà´Ÿàµà´°à´¿à´•àµ¾à´•àµà´•à´¾à´¯à´¿ à´¸àµà´¥à´¿à´° à´ªàµà´°à´•à´Ÿà´¨à´µàµà´‚ à´•àµà´±à´žàµà´ž à´ªàµà´°à´µàµ¼à´¤àµà´¤à´¨ à´šàµ†à´²à´µàµà´‚ à´¨àµ½à´•àµà´¨àµà´¨ à´šàµ†à´²à´µàµà´•àµà´±à´žàµà´ž à´—àµà´¯à´¾à´¸àµ à´ªà´°à´¿à´¹à´¾à´°à´‚.',
        cost: 'à´šàµ†à´²à´µàµà´•àµà´±à´µàµ',
        reliable: 'à´µà´¿à´¶àµà´µà´¾à´¸àµà´¯à´¤',
        maintenance: 'à´•àµà´±à´žàµà´ž à´ªà´°à´¿à´ªà´¾à´²à´¨à´‚'
      }
    },
    // Training Section
    training: {
      title: 'à´ªà´°à´¿à´¶àµ€à´²à´¨à´‚ & à´•à´´à´¿à´µàµ à´µà´¿à´•à´¸à´¨à´‚',
      subtitle: 'à´žà´™àµà´™àµ¾ à´¨àµ½à´•àµà´¨àµà´¨ à´ªà´°à´¿à´¶àµ€à´²à´¨à´‚:',
      module1: 'à´²àµ‹à´£àµà´Ÿàµà´°à´¿ à´®àµ†à´·àµ€àµ» à´ªàµà´°à´µàµ¼à´¤àµà´¤à´¨à´‚',
      module2: 'à´®àµ†à´·àµ€àµ» à´ªà´°à´¿à´ªà´¾à´²à´¨à´‚',
      module3: 'à´µà´¸àµà´¤àµà´°à´‚ à´•à´´àµà´•àµ½ & à´¸àµà´±àµà´±àµ†à´¯à´¿àµ» à´¨àµ€à´•àµà´•à´‚',
      module4: 'à´·àµ‹à´ªàµà´ªàµ à´®à´¾à´¨àµ‡à´œàµà´®àµ†à´¨àµà´±àµ',
      module5: 'à´¹àµˆà´œàµ€àµ» & à´¸àµà´°à´•àµà´·à´¾ à´®à´¾à´¨à´¦à´£àµà´¡à´™àµà´™àµ¾',
      module6: 'à´‰à´ªà´­àµ‹à´•àµà´¤àµƒ à´•àµˆà´•à´¾à´°àµà´¯à´‚ à´šàµ†à´¯àµà´¯àµ½',
      module7: 'à´µà´¿à´²à´¨à´¿àµ¼à´£àµà´£à´¯à´‚ & à´²à´¾à´­ à´“à´ªàµà´±àµà´±à´¿à´®àµˆà´¸àµ‡à´·àµ»'
    },
    // Who Can Join Section
    whoCanJoin: {
      title: 'à´†àµ¼à´•àµà´•àµ†à´²àµà´²à´¾à´‚ à´šàµ‡à´°à´¾à´‚?',
      subtitle: 'à´®àµà´¨àµâ€à´ªà´°à´¿à´šà´¯à´‚ à´†à´µà´¶àµà´¯à´®à´¿à´²àµà´²',
      category1: 'à´ªà´°à´®àµà´ªà´°à´¾à´—à´¤ à´§àµ‹à´¬à´¿ à´•àµà´Ÿàµà´‚à´¬à´™àµà´™àµ¾',
      desc1: 'à´¨à´¿à´™àµà´™à´³àµà´Ÿàµ† à´ªà´°à´®àµà´ªà´°à´¾à´—à´¤ à´•à´´à´¿à´µàµ à´†à´§àµà´¨à´¿à´• à´¸à´¾à´™àµà´•àµ‡à´¤à´¿à´•à´µà´¿à´¦àµà´¯à´¯à´¿à´²àµ‚à´Ÿàµ† à´‰à´¯àµ¼à´¤àµà´¤à´¿à´•àµà´•àµŠà´£àµà´Ÿàµ à´¸àµà´¥à´¿à´°à´¤à´¯àµà´³àµà´³ à´¬à´¿à´¸à´¿à´¨à´¸àµ à´¨à´¿àµ¼à´®àµà´®à´¿à´•àµà´•àµà´•.',
      category2: 'à´¸àµà´¤àµà´°àµ€à´•àµ¾ / à´—àµƒà´¹à´£à´¿à´•àµ¾',
      desc2: 'à´•àµà´Ÿàµà´‚à´¬ à´¬à´¾à´§àµà´¯à´¤à´•à´³àµ‹à´Ÿàµ à´’à´¤àµà´¤àµ à´ªàµ‹à´•àµà´¨àµà´¨ à´¸à´®à´¯à´•àµà´°à´®à´¤àµà´¤à´¿àµ½ à´¸à´¾à´®àµà´ªà´¤àµà´¤à´¿à´• à´¸àµà´µà´¾à´¤à´¨àµà´¤àµà´°àµà´¯à´‚ à´¨àµ‡à´Ÿàµ‚.',
      category3: 'à´­à´¿à´¨àµà´¨à´¶àµ‡à´·à´¿à´•àµà´•à´¾àµ¼',
      desc3: 'à´…àµ¼à´¤àµà´¥à´µà´¤àµà´¤à´¾à´¯ à´¤àµŠà´´à´¿àµ½à´•àµà´•àµ à´¤àµà´²àµà´¯à´¾à´µà´¸à´°à´‚. à´ªàµà´°à´¤àµà´¯àµ‡à´• à´ªà´°à´¿à´¶àµ€à´²à´¨à´µàµà´‚ à´²à´­àµà´¯à´¤ à´¸àµ—à´¹àµƒà´¦ à´‰à´ªà´•à´°à´£à´™àµà´™à´³àµà´‚ à´¨àµ½à´•àµà´¨àµà´¨àµ.',
      category4: 'à´¤àµŠà´´à´¿àµ½ à´‡à´²àµà´²à´¾à´¤àµà´¤ à´¯àµà´µà´¾à´•àµà´•àµ¾',
      desc4: 'à´ªàµ‚àµ¼à´£àµà´£ à´ªà´¿à´¨àµà´¤àµà´£à´¯àµ‹à´Ÿàµ† à´¸à´‚à´°à´‚à´­à´• à´¯à´¾à´¤àµà´° à´†à´°à´‚à´­à´¿à´•àµà´•àµà´•. à´ªàµà´°à´¾à´¯àµ‹à´—à´¿à´• à´•à´´à´¿à´µàµà´•àµ¾ à´…à´­àµà´¯à´¸à´¿à´šàµà´šàµ à´¸àµà´µà´¨àµà´¤à´®à´¾à´¯à´¿ à´¬à´¿à´¸à´¿à´¨à´¸àµ à´¤àµà´Ÿà´™àµà´™àµà´•.',
      category5: 'à´šàµ†à´±à´¿à´¯ à´¬à´¿à´¸à´¿à´¨à´¸àµ à´¤àµà´Ÿà´™àµà´™à´¾àµ» à´†à´—àµà´°à´¹à´¿à´•àµà´•àµà´¨àµà´¨à´µàµ¼',
      desc5: 'à´•àµà´±à´žàµà´ž à´¨à´¿à´•àµà´·àµ‡à´ªà´¤àµà´¤à´¿àµ½ à´‰à´¯àµ¼à´¨àµà´¨ à´µà´°àµà´®à´¾à´¨à´‚. à´¤àµà´Ÿàµ¼à´šàµà´šà´¯à´¾à´¯ à´®à´¾àµ¼à´—à´¨à´¿àµ¼à´¦àµà´¦àµ‡à´¶à´¤àµà´¤àµ‹à´ŸàµŠà´ªàµà´ªà´‚ à´ªàµ‚àµ¼à´£àµà´£ à´¬à´¿à´¸à´¿à´¨à´¸àµ à´¸à´œàµà´œàµ€à´•à´°à´£à´‚.'
    },
    // Franchise Section
    franchise: {
      title: 'à´«àµà´°à´¾à´žàµà´šàµˆà´¸à´¿',
      subtitle: 'à´žà´™àµà´™àµ¾ à´¨àµ½à´•àµà´¨àµà´¨à´¤àµ:',
      item1: 'à´ªàµ‚àµ¼à´£àµà´£ à´¬à´¿à´¸à´¿à´¨à´¸àµ à´¸àµ†à´±àµà´±à´ªàµà´ªàµ',
      item2: 'à´¸àµà´±àµà´±àµ‹àµ¼ à´¡à´¿à´¸àµˆàµ»',
      item3: 'à´¬àµà´°à´¾àµ»à´¡àµ à´¨àµ†à´¯à´¿à´‚',
      item4: 'à´®àµ†à´·àµ€à´¨àµà´•àµ¾',
      item5: 'à´ªàµ‚àµ¼à´£àµà´£ à´ªà´°à´¿à´¶àµ€à´²à´¨à´‚',
      item6: 'à´®à´¾àµ¼à´•àµà´•à´±àµà´±à´¿à´‚à´—àµ à´ªà´¿à´¨àµà´¤àµà´£',
      item7: 'à´¡à´¿à´œà´¿à´±àµà´±àµ½ à´®à´¾àµ¼à´•àµà´•à´±àµà´±à´¿à´‚à´—àµ',
      item8: 'à´¤àµà´Ÿàµ¼à´šàµà´šà´¯à´¾à´¯ à´®à´¾àµ¼à´—à´¨à´¿àµ¼à´¦àµà´¦àµ‡à´¶à´‚'
    },
    // CSR & Government Support Section
    csrSupport: {
      title: 'CSR & à´¸àµ¼à´•àµà´•à´¾àµ¼ à´ªà´¿à´¨àµà´¤àµà´£',
      subtitle: 'à´žà´™àµà´™àµ¾ à´¸à´¹à´•à´°à´¿à´•àµà´•àµà´¨àµà´¨à´¤àµ:',
      partner1: 'à´•àµ‹àµ¼à´ªàµà´ªà´±àµ‡à´±àµà´±àµ CSR à´ªà´¦àµà´§à´¤à´¿à´•àµ¾',
      partner2: 'à´¬à´¾à´™àµà´•àµà´•àµ¾',
      partner3: 'à´¸àµ¼à´•àµà´•à´¾àµ¼ à´¸àµà´µà´¯à´‚à´¤àµŠà´´à´¿àµ½ à´ªà´¦àµà´§à´¤à´¿à´•àµ¾',
      partner4: 'à´•à´´à´¿à´µàµ à´µà´¿à´•à´¸à´¨ à´ªà´¦àµà´§à´¤à´¿à´•àµ¾',
      description: 'à´‡à´µ à´µà´´à´¿ à´…àµ¼à´¹à´°à´¾à´¯à´µàµ¼à´•àµà´•àµ à´§à´¨à´¸à´¹à´¾à´¯à´µàµà´‚ à´ªà´°à´¿à´¶àµ€à´²à´¨à´µàµà´‚ à´²à´­àµà´¯à´®à´¾à´•àµà´•àµà´¨àµà´¨àµ'
    },
    // Contact Section
    contact: {
      title: 'à´žà´™àµà´™à´³àµ† à´¬à´¨àµà´§à´ªàµà´ªàµ†à´Ÿàµ‚',
      subtitle: 'à´¨à´¿à´™àµà´™à´³àµà´Ÿàµ† à´­à´¾à´µà´¿ à´®à´¾à´±àµà´±à´¾àµ» à´¤à´¯àµà´¯à´¾à´±à´¾à´£àµ‹? à´‰à´ªà´•à´°à´£à´™àµà´™à´³àµà´‚ à´®à´¾àµ¼à´—à´¨à´¿àµ¼à´¦àµà´¦àµ‡à´¶à´µàµà´‚ à´¸à´‚à´¬à´¨àµà´§à´¿à´šàµà´šàµ à´žà´™àµà´™à´³àµ† à´¸à´®àµ€à´ªà´¿à´•àµà´•àµ‚.',
      phone: 'à´«àµ‹àµº',
      email: 'à´‡à´®àµ†à´¯à´¿àµ½',
      location: 'à´ªà´°à´®àµà´ªà´°à´¾à´—à´¤',
      locationValue: 'à´¤à´¿à´°àµà´µà´¨à´¨àµà´¤à´ªàµà´±à´‚, à´•àµ‡à´°à´³à´‚',
      formTitle: 'à´¸à´¨àµà´¦àµ‡à´¶à´‚ à´…à´¯à´¯àµà´•àµà´•àµ‚',
      fullName: 'à´ªàµ‚àµ¼à´£àµà´£ à´ªàµ‡à´°àµ',
      fullNamePlaceholder: 'à´¨à´¿à´™àµà´™à´³àµà´Ÿàµ† à´ªàµ‡à´°àµ',
      phoneNumber: 'à´«àµ‹àµº à´¨à´®àµà´ªàµ¼',
      phonePlaceholder: '+91...',
      locationLabel: 'à´ªà´°à´®àµà´ªà´°à´¾à´—à´¤',
      locationPlaceholder: 'à´¨à´—à´°à´‚, à´ªàµà´°à´¦àµ‡à´¶à´‚',
      message: 'à´¸à´¨àµà´¦àµ‡à´¶à´‚',
      messagePlaceholder: 'à´¨à´¿à´™àµà´™à´³àµà´Ÿàµ† à´ªà´¦àµà´§à´¤à´¿à´•à´³àµ†à´•àµà´•àµà´±à´¿à´šàµà´šàµ à´žà´™àµà´™à´³àµ‹à´Ÿàµ à´ªà´±à´¯àµ‚...',
      send: 'à´¸à´¨àµà´¦àµ‡à´¶à´‚ à´…à´¯à´¯àµà´•àµà´•àµà´•'
    },
    // Footer
    footer: {
      rights: 'All rights reserved.'
...
const GlobalStyles = () => (
  <style>{`
    /* --- FONTS: Malayalam-friendly font stack --- */
    /* Montserrat for Hero heading - bold, modern, professional */
    @import url('https://fonts.googleapis.com/css2?family=Montserrat:wght@700;800;900&family=Poppins:wght@400;500;600;700;800;900&family=Quicksand:wght@400;500;600;700&family=Manjari:wght@400;700&family=Noto+Sans+Malayalam:wght@400;500;600;700;800;900&family=Coiny&family=Cormorant+Garamond:wght@400;500;600;700&display=swap');

    :root {
      --font-primary: 'Noto Sans Malayalam', 'Manjari', sans-serif;
    ...
    /* Force all text elements to use the Malayalam-friendly fonts */
...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-[680px] md:min-h-0 md:h-screen pt-0 md:pt-0 flex items-center justify-center overflow-visible md:overflow-hidden bg-white" aria-label="Hero section – Nammude Laundry franchise overview">
      ...
      <div className="fixed left-2 md:left-4 top-1/2 -translate-y-1/2 z-30 flex flex-col gap-1.5 md:gap-4 pointer-events-auto" role="complementary" aria-label="Social media links">
        <a href="https://www.facebook.com/profile.php?id=61587104255575" target="_blank" rel="noopener noreferrer" aria-label="Follow Nammude Laundry on Facebook" className="w-8 h-8 md:w-12 md:h-12 rounded bg-blue-600 text-white flex items-center justify-center hover:bg-blue-700 transition-colors shadow-lg">
          <Facebook size={14} className="md:w-5 md:h-5" aria-hidden="true" />
        </a>
        <a href="https://wa.me/919944328471?text=Hi" target="_blank" rel="noopener noreferrer" aria-label="Contact Nammude Laundry on WhatsApp" className="w-8 h-8 md:w-12 md:h-12 rounded bg-green-500 text-white flex items-center justify-center hover:bg-green-600 transition-colors shadow-lg">
          <MessageCircle size={14} className="md:w-5 md:h-5" aria-hidden="true" />
        </a>
        <a href="https://www.instagram.com/nammude_laundry/" target="_blank" rel="noopener noreferrer" aria-label="Follow Nammude Laundry on Instagram" className="w-8 h-8 md:w-12 md:h-12 rounded bg-red-600 text-white flex items-center justify-center hover:bg-red-700 transition-colors shadow-lg">
          <Instagram size={14} className="md:w-5 md:h-5" aria-hidden="true" />
        </a>
        <a href="https://www.linkedin.com/company/nammude-laundry" target="_blank" rel="noopener noreferrer" aria-label="Connect with Nammude Laundry on LinkedIn" className="w-8 h-8 md:w-12 md:h-12 rounded bg-blue-700 text-white flex items-center justify-center hover:bg-blue-800 transition-colors shadow-lg">
...
const WhyNammude = () => {
  const { t } = useLanguage();
  const reasons = [
    { text: t.whyNammude.reason1, icon: Sparkles },
    { text: t.whyNammude.reason2, icon: DollarSign },
    { text: t.whyNammude.reason3, icon: CheckCircle },
    { text: t.whyNammude.reason4, icon: Wrench },
    { text: t.whyNammude.reason5, icon: Waves }
  ];

  return (
    <section id="why-nammude" className="py-20 relative overflow-hidden z-10" aria-labelledby="why-nammude-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="bg-white rounded-[2rem] shadow-2xl overflow-hidden grid lg:grid-cols-5 border border-slate-100">
            ...
            <div className="lg:col-span-3 p-12 bg-white">
              <form className="space-y-6" onSubmit={sendEmail}>
                <h3 className="text-2xl font-bold text-[#003366] mb-6 font-heading">{t.contact.formTitle}</h3>
    ...
    <footer className="bg-white text-slate-600 py-12 border-t border-slate-200 z-10 relative" role="contentinfo" aria-label="Nammude Laundry footer">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="text-sm">
          Â© {new Date().getFullYear()} NAMMUDE LAUNDRY – NAMMUDE LAUNDRY. {t.footer.rights}
        </div>
      </div>
    </footer>
  );
    ...
    <ErrorBoundary>
      <LanguageProvider>
        <div className="antialiased text-slate-900 bg-white selection:bg-[#A50034] selection:text-white relative">
          ...
          <GlobalStyles />
          <Navbar />
          <main id="main-content" role="main" aria-label="Nammude Laundry – main content">
            <div className="pt-20">
              <ScrollProgress />
              <Hero />
              <WhoCanJoin />
